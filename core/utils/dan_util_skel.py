...
joint_names_common_smpl_n_mirror = [
    "nose", "neck", "right_shoulder", "right_elbow", "right_wrist", "left_shoulder",
    "left_elbow", "left_wrist", "pelvis",
    "right_hip","right_knee","right_ankle","left_hip","left_knee","left_ankle","right_eye","left_eye","right_ear",
    "left_ear","left_big_toe","left_small_toe","left_heel","right_big_toe","right_small_toe","right_heel"
...
#mirror_to_mirror25 = [joint_names_mirrored_human.index(name) for name in joint_names_mirrored_human_25]
#h36m_to_mirror15_names = [joint_names_H36M[n] for n in h36m2mirror15]
...
#joint_names_common_H36M_Mirror = ["right_hip", "right_knee", "right_ankle", "left_hip", "left_knee",
#               "left_ankle", "neck", "nose", "left_shoulder", "left_elbow", 
#               "left_wrist", "right_shoulder", "right_elbow", "right_wrist"]